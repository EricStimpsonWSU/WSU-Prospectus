...
%% Add barriers at subsections too
%\makeatletter
...
% Figures and special math symbols
\usepackage{subcaption} % Include in your preamble
\usepackage{tikz}
...
% Equation numbering in appendices
\newcommand{\setappendixlabel}[1]{%
  \renewcommand{\thesection}{#1}%
  \renewcommand{\theequation}{#1.\arabic{equation}}%
  \setcounter{equation}{0}%
}

% Appendix labeling and referencing
\newcommand{\appendixsection}[2]{%
  \renewcommand{\thesection}{#1}%        % make \thesection produce A, B, ...
  \refstepcounter{section}%              % step the section counter for \label
  \renewcommand{\theequation}{#1.\arabic{equation}}% 
  \setcounter{equation}{0}%
  \section*{APPENDIX #1}%
...
% Compile Appendix A
\phantomsection
\input{appendixA-DFT-FreeEnergy}
\clearpage

% Compile Appendix B
\phantomsection
\input{appendixB-DDFT-EOM}
\clearpage

% Compile Appendix C
\phantomsection
\input{appendixC-PFC-Rescaling}
\clearpage

% Compile Appendix D
\phantomsection
\input{appendixD-PFC-PhaseDiagram}
\clearpage

% Compile Appendix E
\phantomsection
\input{appendixE-Odd-Elasticity}
\clearpage
